...
public class SpellsGoneWrongCommonConfig {
    ...
    public static final ModConfigSpec.ConfigValue<Boolean> DISABLE_SCULK_TENTACLES;
    public static final ModConfigSpec.ConfigValue<Boolean> DISABLE_SONIC_BOOM;
    public static final ModConfigSpec.ConfigValue<Boolean> DISABLE_ELDRITCH_BLAST;
    public static final ModConfigSpec.ConfigValue<Boolean> DISABLE_ABYSSAL_SHROUD;
    public static final ModConfigSpec.ConfigValue<Boolean> DISABLE_PLANAR_SIGHT;
    public static final ModConfigSpec.ConfigValue<Boolean> DISABLE_TELEKINESIS;
    public static final ModConfigSpec.ConfigValue<Boolean> DISABLE_BLACKHOLE;
