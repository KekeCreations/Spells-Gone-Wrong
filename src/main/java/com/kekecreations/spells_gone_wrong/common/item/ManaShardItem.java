        ...
        if (!level.isClientSide()) {
            if (level.getFluidState(blockPos.above()).isEmpty()) {
                if (player != null) {
                    ...
                    MagicManager.spawnParticles(level, new BlastwaveParticleOptions(1.0F, 1.0F, 1.0F, 2.0F), blockPos.getX() + 0.5F, blockPos.getY() + 1.2F, blockPos.getZ() + 0.5F, 0, (double) 0.0F, (double) 0.0F, (double) 0.0F, (double) 0.0F, false);
                    MagicManager.spawnParticles(level, new BlastwaveParticleOptions(0.0F, 1.0F, 1.0F, 6.0F), blockPos.getX() + 0.5F, blockPos.getY() + 1.2F, blockPos.getZ() + 0.5F, 0, (double) 0.0F, (double) 0.0F, (double) 0.0F, (double) 0.0F, false);
